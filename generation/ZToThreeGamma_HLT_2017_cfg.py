...
# with command line options: --python_filename ZToThreeGamma_HLT_2017_cfg.py --eventcontent RAWSIM --datatier GEN-SIM-RAW --fileout file:pprocess.root --conditions 94X_mc2017_realistic_v15 --customise_commands process.source.bypassVersionCheck =  cms.untracked.bool(True) --step HLT:2e34v40 --geometry DB:Extended --filein file:processIN.rioit --era Run2_2017 --no_exec --mc -n 10

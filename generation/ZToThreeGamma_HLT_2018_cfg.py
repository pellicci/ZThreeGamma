...
# with command line options: --python_filename ZToThreeGamma_HLT_2018_cfg.py --eventcontent RAWSIM --datatier GEN-SIM-RAW --fileout process.root --conditions 102X_upgrade2018_realistic_v15 --customise_commands process.source.bypassVersionCheck = cms.untracked.bool(True) --step HLT:2018v32 --geometry DB:Extended --filein file:processIN.root --era Run2_2018 --no_exec --mc -n 10
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('process.root'),

...
# with command line options: --python_filename ZToThreeGamma_MINI_2017_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:process.root --conditions 106X_mc2017_realistic_v6 --step PAT --geometry DB:Extended --filein file:processIN.root --era Run2_2017 --runUnscheduled --no_exec --mc -n 10

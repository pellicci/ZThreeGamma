...
# with command line options: --python_filename ZLLAnalysis-2016-SIM_cfg.py --eventcontent RAWSIM --datatier GEN-SIM --fileout file:ZLLAnalysis-2016-SIM.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step SIM --geometry DB:Extended --filein ZLLAnalysis-2016-LHEGEN.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 30
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('--python_filename nevts:30'),

...
# with command line options: --python_filename ZToThreeGamma_MINI_2018_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:process.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step PAT --geometry DB:Extended --filein file:processIN.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 10

...
# with command line options: --python_filename EGM-RunIISummer20UL16MiniAOD-00001_1_cfg.py --eventcontent MINIAODSIM --datatier MINIAODSIM --fileout file:process.root --conditions 106X_mcRun2_asymptotic_v13 --step PAT --geometry DB:Extended --filein file:processIN.root --era Run2_2016 --runUnscheduled --no_exec --mc -n 1

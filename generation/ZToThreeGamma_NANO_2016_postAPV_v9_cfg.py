...
# with command line options: --python_filename ZToThreeGamma_NANO_2016_postAPV_v9_cfg.py --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --fileout file:process.root --conditions 106X_mcRun2_asymptotic_v17 --step NANO --era Run2_2016,run2_nanoAOD_106Xv2 --no_exec --mc -n 10
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:--python_filename_PAT.root'),

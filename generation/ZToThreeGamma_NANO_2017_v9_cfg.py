...
# with command line options: --python_filename ZToThreeGamma_NANO_2017_v9_cfg.py --eventcontent NANOEDMAODSIM --datatier NANOAODSIM --fileout file:process.root --conditions 106X_mc2017_realistic_v9 --step NANO --era Run2_2017,run2_nanoAOD_106Xv2 --no_exec --mc -n 10

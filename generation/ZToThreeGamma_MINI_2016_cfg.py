...
# with command line options: --python_filename ZToThreeGamma_MINI_2016_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:process.root --conditions 106X_mcRun2_asymptotic_preVFP_v8 --step PAT --geometry DB:Extended --filein process.root --era Run2_2016_HIPM --runUnscheduled --no_exec --mc -n 10

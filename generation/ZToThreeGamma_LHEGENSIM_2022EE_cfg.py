...
# with command line options: Configuration/GenProduction/python/Zthreegamma_fragment.py --eventcontent RAWSIM,LHE --datatier GEN-SIM,LHE --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --step LHE,GEN,SIM --geometry DB:Extended --era Run3 --python_filename PPD-Run3Summer22EEwmLHEGS-00003_1_cfg.py --fileout file:process.root --number 100 --number_out 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Zthreegamma_fragment.py nevts:100'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:process_inLHE.root'),
...
process.generator = cms.EDFilter("Pythia8HadronizerFilter",
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            list_forced_decays = cms.vstring('MyZ0'),
            operates_on_particles = cms.vint32(23),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/el8_amd64_gcc10/Powheg/V2/Z_el8_amd64_gcc11_CMSSW_13_0_17_NoDecay.tgz'),

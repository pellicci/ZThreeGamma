...
# with command line options: --python_filename ZToThreeGamma_RECO_2017_cfg.py --eventcontent AODSIM --datatier AODSIM --fileout file:process.root --conditions 106X_mc2017_realistic_v6 --step RAW2DIGI,L1Reco,RECO,RECOSIM --geometry DB:Extended --filein file:processIN.root --era Run2_2017 --runUnscheduled --no_exec --mc -n 10

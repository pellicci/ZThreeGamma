...
# with command line options: Configuration/GenProduction/python/TAU-RunIISummer20UL16wmLHEGEN-00001-fragment.py --python_filename ZToThreeGamma_LHEGEN_2016_postAPV_v9_cfg.py --eventcontent RAWSIM,LHE --datatier GEN,LHE --fileout file:process.root --conditions 106X_mcRun2_asymptotic_v13 --beamspot Realistic25ns13TeV2016Collision --step LHE,GEN --geometry DB:Extended --era Run2_2016 --no_exec --mc -n 500
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TAU-RunIISummer20UL16wmLHEGEN-00001-fragment.py nevts:500'),

...
# with command line options: --python_filename ZToThreeGamma_RECO_2018_cfg.py --eventcontent AODSIM --datatier AODSIM --fileout file:process.root --conditions 106X_upgrade2018_realistic_v11_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --geometry DB:Extended --filein file:processIN.root --era Run2_2018 --runUnscheduled --no_exec --mc -n 10
